...
public class ProjectStockStatisticsController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "projectStockStatisticss", method = RequestMethod.GET)
	@RequiresPermissions(value = "projectStockStatistics:list")
	@SystemControllerLog(description = "查询所有项目库存统计")
	public String list(@RequestParam(value = "pageNo", defaultValue = "1") Integer pageNo, Model model,
		...
		return "projectStockStatistics/projectStockStatistics";
	}
