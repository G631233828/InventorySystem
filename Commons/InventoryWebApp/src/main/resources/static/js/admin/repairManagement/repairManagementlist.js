...
function searchVal() {
	...
	window.location.href = "repairManagements?pageSize=" + pageSize + "&search="
...
$.ajax({
		type : 'POST',
		url : getRootPath() + "/repairManagement/deleteInSession",
		dataType : "json",
		data: "id=" + o,
...
function toExport() {
	...
	window.location.href = "repairManagement/export?search=" + search + "&start=" + start + "&end=" + end ;
